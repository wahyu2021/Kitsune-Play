...
export default function InfoPanel({ game, onPlay, onEdit, onDelete }: InfoPanelProps): React.JSX.Element {
  return (
    <div className="flex max-w-xl flex-col items-start gap-4">
      ...
      >
        ...
        <span className="rounded bg-white/20 px-2 py-1 backdrop-blur-md">{game.genre || 'Game'}</span>
      </motion.div>
      ...
      <motion.p
        ...
        className="line-clamp-3 text-lg text-white/80 drop-shadow-md"
      >
        {game.description}
      </motion.p>
